...
Version  : 24.12.2
Release  : 78
URL      : https://download.kde.org/stable/release-service/24.12.2/src/ktimer-24.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/ktimer-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/ktimer-24.12.2.tar.xz.sig
...
%setup -q -n ktimer-24.12.2
cd %{_builddir}/ktimer-24.12.2
pushd ..
cp -a ktimer-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738951399
mkdir -p clr-build
pushd clr-build
