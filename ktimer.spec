...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/ktimer-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/ktimer-24.12.0.tar.xz.sig
...
%setup -q -n ktimer-24.12.0
cd %{_builddir}/ktimer-24.12.0
pushd ..
cp -a ktimer-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735177686
mkdir -p clr-build
pushd clr-build
